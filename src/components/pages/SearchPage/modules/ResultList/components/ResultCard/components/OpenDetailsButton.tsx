...
export const OpenDetailsButton = ({ onClick, isOpen, text, className }: Props) => {
  return (
    <div className={cn(``, className)}>
      <Button
        variant={"link"}
        onClick={onClick}
        className="flex items-center gap-px p-0 text-primary_1 button_underline_bolt_text"
      >
        {text}
        <div className="hidden tablet:block">
          <svg
            ...
            viewBox="0 0 25 24"
            fill="none"
            className={`rotate-0 ${isOpen && "rotate-180"} transition-all	`}
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
